...
GST_DEBUG=2 gst-launch-1.0 \
    filesrc location=mono2.png ! pngdec ! videoscale ! videoconvert ! video/x-raw,width=640,height=640 ! tee name=t \
    ...
    tensor_decoder mode=bounding_boxes option1=yolov8 option2=thermal.txt option4=640:640 option5=320:320 ! \
